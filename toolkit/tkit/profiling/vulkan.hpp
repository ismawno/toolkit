...
#    define TKIT_PROFILE_CREATE_VULKAN_CONTEXT(instance, physdev, device, queue, cmdbuf, getInstance, getDevice)       \
        TracyVkContext(instance, physdev, device, queue, cmdbuf, getInstance, getDevice)
#    define TKIT_PROFILE_CREATE_VULKAN_CALIBRATED_CONTEXT(instance, physdev, device, queue, cmdbuf, gpdctd, gct,       \
                                                          getInstance, getDevice)                                      \
        TracyVkContextCalibrated(instance, physdev, device, queue, cmdbuf, gpdctd, gct, getInstance, getDevice)
